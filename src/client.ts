...
export interface ClientOptions {
   ...
   * - `test` corresponds to `https://api-testing.sully.ai`
   */
...
export class SullyAI {
   ...
   * @param {string} [opts.baseURL=process.env['SULLY_AI_BASE_URL'] ?? https://api.sully.ai] - Override the default base URL for the API.
  ...
  protected async authHeaders(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
    return buildHeaders([await this.apiKeyAuth(opts), await this.accountIDAuth(opts)]);
  }
  ...
  protected async accountIDAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
